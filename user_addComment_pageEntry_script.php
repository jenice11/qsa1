...
$query = "SELECT user_id, user_fk, page_fk, page_id from user_info, comment_table,page_info WHERE user_info.user_id=comment_table.user_fk AND comment_table.user_fk='$user_id' AND page_info.page_id=comment_table.page_fk";
