        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="block wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="500ms">
                    <h2>
                    ABOUT QUIT SMOKING ADVISOR
                    </h2>
                    <p>
                        This allows both user and advisor to interact with each other without having the need to physically have an appointment.
                    </p>
                    <p>
                        While having an online quit plan tailored by the qualified advisor, more convenience is given to smokers to easily stop.
                    </p>
                </div>
...
<section id="works" class="works">
    <div class="container">
        <div class="section-heading">
            <h1 class="title wow fadeInDown" data-wow-delay=".3s">Types of Quit Plan</h1>
